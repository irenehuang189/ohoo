...
@section('right-column')
    <div class="ui small form">
        ...
        <div class="row">
            @if($blank == 1)
                <button class="ui horizontal animated teal large fluid button show-report-bayangan-blank" tabindex="0">
                    @elseif($blank == 0)
                        <button class="ui horizontal animated teal large fluid button show-report-bayangan" tabindex="0">
                            @endif
