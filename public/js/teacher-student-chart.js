...
$.get("/teacher/individu/getMeanStatistic/" + studentId, function (data, status){
  var nilai = [];
  var kelas = [];
...
$.get("/teacher/individu/getRankStatistic/" + studentId, function (data, status){
  var rank = [];
  var kelas = [];
  $.each(data, function(i, statistik) {
...
$.get("/teacher/individu/getCapabilityStatistic/" + studentId, function (data, status){
  var nilai = [];
  var courses = [];
  $.each(data, function(i, statistik) {
    nilai.push(statistik.avg);
...
$("#histori-nilai").change(function(){
  ...
  $.get("/teacher/individu/getHistoryCoursesStatistic/" + studentId + "/" + courses, function (data, status){
    var tabNilai = [];
    var kelas = [];
